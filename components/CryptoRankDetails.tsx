...
type Tile = { icon: LucideIcon; label: string; value: string; chain?: string };
    ...
    <section className="crx-card" aria-label="CryptoRank data">
      ...
      {hasTopbar ? (
        <div className="crx-topbar">
          {p.twitterScore != null ? (
            <MoniGauge score={Number(p.twitterScore)} />
          ) : null}
            ...
            return (
              <div key={t.label} className="crx-tile">
                <span className="crx-tile__icon">
                  {t.chain ? <ChainIcon chain={t.chain} size={18} /> : <Icon size={16} />}
                </span>
