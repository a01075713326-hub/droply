...
type Tone = "neutral" | "ok" | "warn" | "caution";
    ...
    <div className="badges-row">
      {badges.map((b) => (
        <div key={b.label + b.value} className={`badge-item badge-item--${b.tone}`}>
          ...
          <span className="badge-item-value">{b.icon}{b.value}</span>
        </div>
      ))}
    </div>
  );
